...
/* 사용 하는법
if(CKeyMgr::GetInstance()->KeyPressed(키종류, 인덱스) == KEYDOWN) // 눌렀을때확인
{}

if(CKeyMgr::GetInstance()->KeyPressed(키종류, 인덱스) == KEYDRAG) // 드래그중 확인
{}

if(CKeyMgr::GetInstance()->KeyPressed(키종류, 인덱스) == KEYUP) // 땠을때 확인
{}
*/