...
const float CFrustum::GetMinArray(const float* fNum, const int iSize)
{
	float fMin = fNum[0];
...
const float CFrustum::GetMaxArray(const float* fNum, const int iSize)
{
	float fMax = fNum[0];
