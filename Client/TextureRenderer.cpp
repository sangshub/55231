...
HRESULT CTextureRenderer::SetMediaType(const CMediaType *pmt )
{
	...
	hr =m_pDevice->CreateTexture(m_lVidWidth , m_lVidHeight , 1, 0, 
...
void CTextureRenderer::ReleaseTexture(void)
{	
	Safe_Release(m_pTexture);
}

void CTextureRenderer::SetTexture(DWORD dwStage)
{
	if(m_pTexture != NULL)
		m_pDevice->SetTexture(dwStage, m_pTexture);
}	