...
HRESULT CRcTex::CreateBuffer()
{
	...
	{
		ERR_MSG(TEXT("CRcTex Buffer Create Fail"));
	...
	pVtxTex[0].vPos = D3DXVECTOR3(-1.f, 0.f, 1.f);
	pVtxTex[0].vTex = D3DXVECTOR2(0.f, 0.f);

	pVtxTex[1].vPos = D3DXVECTOR3(1.f, 0.f, 1.f);
	pVtxTex[1].vTex = D3DXVECTOR2(1.f, 0.f);

	pVtxTex[2].vPos = D3DXVECTOR3(1.f, 0.f, -1.f);
	pVtxTex[2].vTex = D3DXVECTOR2(1.f, 1.f);

	pVtxTex[3].vPos = D3DXVECTOR3(-1.f, 0.f, -1.f);
